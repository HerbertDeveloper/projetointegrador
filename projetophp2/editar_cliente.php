...
// armazenar na variável o comando de consulta com o id
$sql_cliente = "SELECT * FROM clientes WHERE id = '$id'";
// realizar a consulta com o comando e retornar erro caso haja
$query_cliente = $mysqli->query($sql_cliente) or die($mysqli->error);
// retornar o conteúdo deste único registro
